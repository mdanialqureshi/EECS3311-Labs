...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1012, Current, 0, 1, 14333);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1012, Current, 14333);
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1012, Current, 1, 1, 14334);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1012, Current, 14334);
	RTCC(arg1, 1012, l_feature_name, 1, RTWCT(4633, dtype, Dftype(Current)), 0x06);
	uarg1 = (EIF_BOOLEAN) RTS_OU (arg1);
	uarg = uarg1;
	if (uarg) {
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1012, Current, 0, 0, 14335);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1012, Current, 14335);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_operands", EX_PRE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1012, Current, 0, 1, 14336);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1012, Current, 14336);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1012, Current, 0, 1, 14337);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1012, Current, 14337);
	RTCC(arg1, 1012, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1012, Current, 0, 1, 14338);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1012, Current, 14338);
...
void F1013_6506 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1012, Current, 1, 0, 14339);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1012, Current, 14339);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 4635, 0x10000000, 0); /* last_result */
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1012, Current, 2, 1, 14340);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1012, Current, 14340);
	if (arg1) {
		{
...
#define arg10 arg10x.it_p
	...
	RTEAA(l_feature_name, 1012, Current, 0, 10, 14341);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1012, Current, 14341);
	RTIV(Current, RTAL);
