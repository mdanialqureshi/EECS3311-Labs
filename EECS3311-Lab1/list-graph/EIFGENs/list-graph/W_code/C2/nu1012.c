...
extern EIF_TYPED_VALUE F1012_7973(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1012_7973 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1011, Current, 1, 2, 14218);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1011, Current, 14218);
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,266,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
			l_type = RTWCT(5629, dtype, Dftype(Current));
	...
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,1012,0xFF01,0xFFF9,1,186,0,0,221,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
			l_type = RTWCT(5629, dtype, Dftype(Current));
