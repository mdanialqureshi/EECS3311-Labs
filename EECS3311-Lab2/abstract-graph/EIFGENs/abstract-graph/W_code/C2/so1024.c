...
extern EIF_TYPED_VALUE F1024_3587(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1024_3588(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1024_3589(EIF_REFERENCE);
...
/* {SORTED_LIST}.min */
EIF_TYPED_VALUE F1024_3587 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1023, Current, 0, 0, 14017);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {SORTED_LIST}.max */
EIF_TYPED_VALUE F1024_3588 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1023, Current, 0, 0, 14018);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {SORTED_LIST}.median */
EIF_TYPED_VALUE F1024_3589 (EIF_REFERENCE Current)
{
	GTCX
