...
extern EIF_TYPED_VALUE F1017_8101(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1017_8102(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1017_8103(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1017_8104(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1017_8101 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1016, Current, 5, 1, 15090);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1016, Current, 15090);
	RTCC(arg1, 1016, l_feature_name, 1, RTWCT(2281, dtype, dftype), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (RTAL & CK_ENSURE) {
		...
		*(EIF_INTEGER_32 *)tr1 = ((EIF_INTEGER_32) 1L);
		...
		for (;;) {
			...
			ui4_1 = ti4_1;
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5591, "item", Result))(Result, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3145, "item", loc4))(loc4)).it_i4);
			ui4_1 = (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L));
			tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5591, "item", Result))(Result, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F1017_8102 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1016, Current, 1, 0, 15091);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1016, Current, 15091);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ur1 = RTCCL(Result);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(2881, Dtype(tr1)))(tr1, ur1x);
	RTNHOOK(2,1);
	loc1 = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(3);
	RTDBGAL(0, 0xF8000100, 0,0); /* Result */
...
/* {COMPARABLE_GRAPH}.pq */
EIF_TYPED_VALUE F1017_8103 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1016, Current, 0, 0, 15092);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1016, Current, 15092);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80003FD, 0,0); /* Result */
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,1021,0xFF01,1052,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
			l_type = RTWCT(2281, dtype, Dftype(Current));
...
EIF_TYPED_VALUE F1017_8104 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1016, Current, 0, 1, 15093);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1016, Current, 15093);
	{
